...
from .widgets import render_dashboard, render_hero, render_metrics, render_smart_alerts
...
def register():
    ...
    def home_page():
        ...
        with ui.element(_TAG).classes('app-container map-app'):
            ...
            with ui.element(_TAG).classes('page-content'):
                if weather.get('error'):
                    ...
                    if user:
                        render_smart_alerts(weather, user['username'])
                    render_hero(weather)
